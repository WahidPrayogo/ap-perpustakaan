...
Public Class lap_pinjam_bulanan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_perpustakaan.lap pinjam bulanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_pinjam_bulanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_pinjam_bulanan = New lap_pinjam_bulanan
        rpt.Site = Me.Site
        Return rpt
    End Function
