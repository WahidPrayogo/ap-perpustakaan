...
Public Class lap_kembali_bulanan
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "lap kembali bulanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_perpustakaan.lap kembali bulanan.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_kembali_bulanan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_kembali_bulanan = New lap_kembali_bulanan
        rpt.Site = Me.Site
        Return rpt
    End Function
