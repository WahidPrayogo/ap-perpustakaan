...
Public Class lap_anggota1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_perpustakaan.lap anggota1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_anggota1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_anggota1 = New lap_anggota1
        rpt.Site = Me.Site
        Return rpt
    End Function
