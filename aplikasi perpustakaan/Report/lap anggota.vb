...
Public Class lap_anggota
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "aplikasi_perpustakaan.lap anggota.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedlap_anggota
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As lap_anggota = New lap_anggota
        rpt.Site = Me.Site
        Return rpt
    End Function
